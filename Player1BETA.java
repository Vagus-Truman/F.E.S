...
public class Player1 {
	...
	public static void indexAndAffect(int indexOfCombos) {
		...
		case 1:
			...
			System.out.println("Player1 loses 0.5 of their current HP. Current HP: " + Player2.healthCount);
		case 2:

		case 3:
			damage = (int) (0.5 * Player2.baseHealth);
			Player2.healthCount -= damage;
			System.out.println("Player1 loses " + damage + " HP. Current HP: " + Player2.healthCount);
		...
		case 19:
			...
			Player1.cardCount += cardsAddedWand;
		...
		case 31:
			...
			System.out.println("Player has " + 2
					+ " new cards added to their hand. Current card count: " + Player1.cardCount);
		...
		case 40:
			...
			System.out.println("Deals damage of " + multiplier
					+ " times current HP to the Player1. Current HP: " + Player2.healthCount);
		case 41:
			multiplier = 2.0;
			damage = (int) (Player1.healthCount * multiplier);
			Player2.healthCount -= damage;
		...
		case 54:
			Player1.cardCount += (handLimit - Player1.cardCount);
			System.out.println("Player has " + 1 + " new card added to their hand. Current card count: "
					+ Player1.cardCount);
