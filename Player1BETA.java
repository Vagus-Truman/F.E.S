...
public class Player1 {
	...
	// counting health
		public static void healthCounter(int healthCount) {

			int currentHealth = healthCount;
	...
	public static void indexAndAffect(int indexOfCombos) {
		...
		case 0:
			...
			System.out.println("Player's health is refilled to " + Player1.healthCount);
			break;
		case 1:
			Player2.healthCount -= (int) (0.5 * Player2.healthCount);
			System.out.println("Player2 loses 0.5 of their current HP. Current HP: " + Player2.healthCount);
			break;
		case 2:
			...
			break;
		case 3:
			damage = (int) (0.5 * Player2.baseHealth);
			Player2.healthCount -= damage;
			System.out.println("Player2 loses " + damage + " HP. Current HP: " + Player2.healthCount);
			break;
		...
		case 8:
			...
			System.out.println(
					"Delivers healing of " + healingAmount + " HP to the player. Current HP: " + Player1.healthCount);
			break;
		case 9:
			damage = 10;
			Player2.healthCount -= damage;
		...
		case 12:
			...
			System.out.println("Delivers " + hpDelivered + " HP to the player. Current HP: " + Player1.healthCount);
			break;
		case 13:
			damage = 50;
			Player2.healthCount -= damage;
			System.out.println(
					"Deals damage of " + damage + " to the Player1. Current HP: " + Player2.healthCount);
			break;
		...
		case 15:
			...
			System.out.println("Player2's HP is equal to Player1's");
			break;
		...
		case 16:
			...
			System.out.println("Delivers " + hpDeliveredCup + " HP to the player. Current HP: " + Player1.healthCount);
			break;
		case 17:
			damage = 25;
			Player2.healthCount -= damage;
			System.out.println(
					"Deals base damage of " + damage + " to the Player1. Current HP: " + Player2.healthCount);
			break;
		...
		case 20:
			...
			System.out.println(
					"Delivers healing of " + multiplier + " times current HP to the player. Current HP: "
							+ Player1.healthCount + ". HP increased by: " + healthIncrease);
			break;
		case 21:
			multiplier = 1.5;
		...
		case 24:
			...
			System.out.println(
					"Delivers healing of " + healingAmountCup + " HP to the player. Current HP: " + Player1.healthCount);
			break;
		case 25:
			damage = 39;
			Player2.healthCount -= damage;
		...
		case 32:
			...
			System.out.println(
					"Delivers healing of " + healingAmountStr + " HP to the player. Current HP: " + Player1.healthCount);
			break;
		case 33:
			damage = 26;
			Player2.healthCount -= damage;
		...
		case 34:
			...
			Player2.healthCount -= damage;
			System.out
					.println("Deals damage of " + damage + " to the Player1. Current HP: " + Player2.healthCount);
			break;
		case 35:
			damage = 26;
			Player2.healthCount -= damage;
		...
		case 36:
			...
			System.out.println(
					"Delivers healing of " + healingHermit + " HP to the player. Current HP: " + Player1.healthCount);
			break;
		...
		case 40:
			...
			System.out.println("Delivers HP of " + multiplier
		...
		case 42:
			...
			Player2.setBurned();
			System.out.println(
					"Deals fire damage of " + multiplier + " times current HP with burned to Player2.");
			break;
		case 43:
			multiplier = 1.5;
			...
			System.out.println("Delivers HP of " + multiplier + "times current HP of Player2 to Player1. "
					+ "Current HP: " + Player1.healthCount);
			break;
